...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(FriendService.FriendNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handleFriendNotFoundException(FriendService.FriendNotFoundException ex) {
        logger.warn("Friend operation failed: {}", ex.getMessage());
        return ResponseEntity
